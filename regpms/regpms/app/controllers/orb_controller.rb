...
class OrbController < ApplicationController
  ...
  def load_menu
    ...
    sub_navs << {:title => KkuTactic.model_name.human, :icon_class => "fa fa-cog", :url => settings_kku_tactics_path, :resource => KkuTactic}
    ...
    sub_navs << {:title => SubBudgetType.model_name.human, :icon_class => "fa fa-cog", :url => settings_sub_budget_types_path, :resource => SubBudgetType}
    sub_navs << {:title => WageRate.model_name.human, :icon_class => "fa fa-cog", :url => settings_wage_rates_path, :resource => WageRate}

   # sub_navs << {:title => AllowanceRate.model_name.human, :icon_class => "fa fa-cog", :url => settings_allowance_rates_path, :resource => AllowanceRate}
