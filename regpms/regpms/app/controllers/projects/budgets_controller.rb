class Projects::BudgetsController < OrbController
  ...
  private
    ...
    def budget_params
      params.require(:budget).permit(id, :workflow_state, :workflow_state_updater_id, :project_id, :sorting, :budget_type_id, :sub_budget_type_id, :wage_rate_id ,:description, :hr, :amount )
    end
