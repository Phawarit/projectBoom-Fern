class Projects::ResponsiblesController < OrbController
  ...
  private
    ...
    def responsible_params
      ...
      params.require(:responsible).permit(:workflow_state, :workflow_state_updater_id, :project_id, :sorting, :user_id, :firstname, :lastname, :responsibility , :percent_of_work)
    end
