...
class Projects::ExpensesController < OrbController
  ...
  def chose_budget_type
    @budget_type = !params[:budget_type_id].blank? && BudgetType.exists?(params[:budget_type_id]) ? BudgetType.find(params[:budget_type_id]) : BudgetType.new
  ...
  def chose_sub_budget_type
    @sub_budget_type = !params[:sub_budget_type_id].blank? && SubBudgetType.exists?(params[:sub_budget_type_id]) ? SubBudgetType.find(params[:sub_budget_type_id]) : SubBudgetType.new
    respond_to do |format|
      format.js
    end
  end
  ...
  def expense_params
    params.require(:expense).permit(:workflow_state, :workflow_state_updater_id, :project_id, :sorting, :budget_type_id, :sub_budget_type_id, :wage_rate_id, :hr, :budget_group_id, :date, :description, :amount, :by)
  end
