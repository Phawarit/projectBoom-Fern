class ProblemSuggesstion < ActiveRecord::Base
  ...
  validates :next_step, presence: true
  validates :percent_of_task, presence: true

  def to_s
    "#{sorting}. #{description}. #{next_step}. #{percent_of_task}"
  end
