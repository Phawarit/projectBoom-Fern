Rails.application.routes.draw do
  ...
  resources :wage_rates
  resources :sub_budget_types
  ...
  namespace :projects do
    ...
    resources :expenses do
      ...
      post :chose_budget_type, on: :collection
      post :chose_sub_budget_type, on: :collection
  ...
  resources :projects do
    ...
    post :chose_kku_strategic, on: :collection
  ...
  namespace :settings do
    resources :budget_types do 
      post :chose_budget_type, on: :collection
    end
    resources :sub_budget_types do 
      post :chose_sub_budget_type, on: :collection
    end
    resources :allowance_rates
    resources :wage_rates
    resources :policies
